...
namespace Scaphoid.Migrations.Migrations
{
    ...
    [Migration("20240308113102_AddRequestAndQuestion")]
    partial class AddRequestAndQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scaphoid.Core.Model.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaphoid.Core.Model.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaphoid.Core.Model.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaphoid.Core.Model.Request", b =>
                {
                    b.HasOne("Scaphoid.Core.Model.Country", "Country")
                        .WithMany()
